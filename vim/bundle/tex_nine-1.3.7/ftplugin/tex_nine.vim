...
" Templates
noremap <buffer><silent> <F9> :call tex_nine#InsertSkeleton(b:tex_nine_skeleton.'.xelatex')<CR>
noremap <buffer><silent> <F10> :call tex_nine#InsertSkeleton(b:tex_nine_skeleton.'.pdflatex')<CR>
noremap <buffer><silent> <F11> :call tex_nine#InsertSkeleton(b:tex_nine_skeleton.'.latex')<CR>
noremap <buffer><silent> <F12> :call tex_nine#InsertSkeleton(b:tex_nine_skeleton.'.make')<CR>
