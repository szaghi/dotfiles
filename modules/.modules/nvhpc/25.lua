whatis("NVIDIA HPC SDK 25")

help([[
NVIDIA HPC SDK 25 — installed at /opt/nvidia/hpc_sdk/Linux_x86_64/2025
...
local root = "/opt/nvidia/hpc_sdk/Linux_x86_64/2025"

family("compiler")

if not isDir(root) then
  LmodError("NVIDIA HPC SDK 25 not found at " .. root)
end
